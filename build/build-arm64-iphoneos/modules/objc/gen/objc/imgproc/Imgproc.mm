...
//
+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)_refine _scale:(double)_scale _sigma_scale:(double)_sigma_scale _quant:(double)_quant _ang_th:(double)_ang_th _log_eps:(double)_log_eps _density_th:(double)_density_th _n_bins:(int)_n_bins {
    cv::Ptr<cv::LineSegmentDetector> retVal = cv::createLineSegmentDetector((cv::LineSegmentDetectorModes)_refine, _scale, _sigma_scale, _quant, _ang_th, _log_eps, _density_th, _n_bins);
    return [LineSegmentDetector fromNative:retVal];
}

+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)_refine _scale:(double)_scale _sigma_scale:(double)_sigma_scale _quant:(double)_quant _ang_th:(double)_ang_th _log_eps:(double)_log_eps _density_th:(double)_density_th {
    cv::Ptr<cv::LineSegmentDetector> retVal = cv::createLineSegmentDetector((cv::LineSegmentDetectorModes)_refine, _scale, _sigma_scale, _quant, _ang_th, _log_eps, _density_th);
    return [LineSegmentDetector fromNative:retVal];
}

+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)_refine _scale:(double)_scale _sigma_scale:(double)_sigma_scale _quant:(double)_quant _ang_th:(double)_ang_th _log_eps:(double)_log_eps {
    cv::Ptr<cv::LineSegmentDetector> retVal = cv::createLineSegmentDetector((cv::LineSegmentDetectorModes)_refine, _scale, _sigma_scale, _quant, _ang_th, _log_eps);
    return [LineSegmentDetector fromNative:retVal];
}

+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)_refine _scale:(double)_scale _sigma_scale:(double)_sigma_scale _quant:(double)_quant _ang_th:(double)_ang_th {
    cv::Ptr<cv::LineSegmentDetector> retVal = cv::createLineSegmentDetector((cv::LineSegmentDetectorModes)_refine, _scale, _sigma_scale, _quant, _ang_th);
    return [LineSegmentDetector fromNative:retVal];
}

+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)_refine _scale:(double)_scale _sigma_scale:(double)_sigma_scale _quant:(double)_quant {
    cv::Ptr<cv::LineSegmentDetector> retVal = cv::createLineSegmentDetector((cv::LineSegmentDetectorModes)_refine, _scale, _sigma_scale, _quant);
    return [LineSegmentDetector fromNative:retVal];
}

+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)_refine _scale:(double)_scale _sigma_scale:(double)_sigma_scale {
    cv::Ptr<cv::LineSegmentDetector> retVal = cv::createLineSegmentDetector((cv::LineSegmentDetectorModes)_refine, _scale, _sigma_scale);
    return [LineSegmentDetector fromNative:retVal];
}

+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)_refine _scale:(double)_scale {
    cv::Ptr<cv::LineSegmentDetector> retVal = cv::createLineSegmentDetector((cv::LineSegmentDetectorModes)_refine, _scale);
    return [LineSegmentDetector fromNative:retVal];
}

+ (LineSegmentDetector*)createLineSegmentDetector:(LineSegmentDetectorModes)_refine {
    cv::Ptr<cv::LineSegmentDetector> retVal = cv::createLineSegmentDetector((cv::LineSegmentDetectorModes)_refine);
    return [LineSegmentDetector fromNative:retVal];
}
...
+ (float)intersectConvexConvex:(Mat*)_p1 _p2:(Mat*)_p2 _p12:(Mat*)_p12 handleNested:(BOOL)handleNested {
    float retVal = cv::intersectConvexConvex(_p1.nativeRef, _p2.nativeRef, _p12.nativeRef, (bool)handleNested);
    return retVal;
}
